...
4. The minimal distance and radius in which to find an overlook     | OPTIONAL (default: [200,400] - if left empty ([]) the group will stay where they are)
...
_owatch = if (_count > 3) then [{_this select 3},{[200,400]}];
